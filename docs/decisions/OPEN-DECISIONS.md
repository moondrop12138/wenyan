...
| 2026-08 | O7 | 知识路由 BM25/精排生产切换 | 任务书前置：100–200 条真实 query 评测集，recall@3 提升 ≥15% 才保留精排层 | 已用 10 个子代理采集 Stack Exchange 公开匿名问答，构建 618 条中文真实素材评测集（route_eval_queries.json）。实测：contains P=0.202/R=0.179；纯 BM25 P=0.130/R=0.317（recall lift=+0.138 < 0.15）。新增「文档画像精排器」实验：全量 P=0.166/R=0.409/F1=0.236；测试集 P=0.153/R=0.372/F1=0.217 vs contains P=0.204/R=0.175/F1=0.188、BM25 P=0.145/R=0.348/F1=0.205。F1 提升 0.029 < 0.05 且 precision 下降 0.051 → **不切换生产，保持 contains 基线**；RouteReranker/DocProfile 保留为实验代码 | 无（数据已完成） | 已按决策门关闭 | RESOLVED |
