...
| 2026-08 | O7 | 知识路由 BM25/精排生产切换 | 任务书前置：100–200 条真实 query 评测集，recall@3 提升 ≥15% 才保留精排层 | 已交付 Bm25Scorer + RouteEvaluator + 纯 BM25 候选生成，生产 route() 维持 contains 基线 | 真实 query 评测集 | 评测集完成且 recall@3 提升 ≥15% | OPEN |
