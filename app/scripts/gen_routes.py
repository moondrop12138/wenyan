...
ROUTE_TABLE = [
    (["回复", "开场", "邀约", "演练", "怎么回", "话术", "转移话题", "第一句"], "practical/实战话术编排器：从一句回复到后续分支.md"),
    (["松弛感", "现场取材", "轻松调情", "调情", "接话", "话题", "冷场", "尬聊", "自然过渡"], "practical/场景感、松弛感与社交校准：从接话到关系推进.md"),
    (["Blueprint", "自然流", "Mystery", "冷读", "内在状态", "结构化互动", "套路", "追女生", "吸引力"], "knowledge/20-经典社交体系的机制、证据与风险边界.md"),
    (["冷读", "PUA", "推拉", "贬低", "服从测试", "煤气灯", "操控", "操纵", "套路", "欲擒故纵", "忽冷忽热", "冷暴力", "情感操纵", "控制欲"], "knowledge/05-PUA操控与伦理替代.md"),
    (["聊天截图", "截图", "网聊", "媒介误读", "隐私", "诈骗", "在线约会", "数字关系", "约会软件", "交友网站", "已读不回", "网友", "网恋", "社交软件", "线上认识", "私密照"], "knowledge/09-在线约会与数字关系.md"),
    (["主动表达", "第一次见面", "自然接触", "搭讪", "邀约", "第一次约会", "约出去", "约认识"], "practical/主动表达、第一次见面与自然接触.md"),
    (["投入失衡", "降级", "退出", "投入", "互惠", "付出", "回报", "索取", "主动联系", "冷淡", "吊着"], "practical/关系投入失衡：互惠判断、降级投入与退出决策.md"),
    (["依恋", "焦虑", "情绪调节", "情绪", "不安", "封闭", "抑郁", "安全感", "害怕被抛弃", "吃醋", "情感封闭"], "knowledge/03-依恋理论与情绪调节.md"),
    (["MBTI", "mbti", "人格"], "knowledge/04-MBTI人格与匹配.md"),
    (["冲突", "沟通", "修复", "吵架", "矛盾", "冷战", "冷暴力", "吃醋", "翻旧账", "沉默", "嘲讽", "多疑", "不沟通", "发脾气", "争吵"], "knowledge/07-沟通冲突与修复.md"),
    (["同意", "性", "亲密", "边界", "身体", "越界", "身体接触", "亲密行为", "私密照", "动手动脚", "发生关系", "性同意", "性行为"], "knowledge/08-同意边界性与亲密.md"),
    (["婚姻", "家庭", "金钱", "家务", "育儿", "双方家庭", "生命周期", "婆婆", "公婆", "岳父", "岳母", "离婚", "夫妻", "结婚", "婚后", "婆媳", "彩礼"], "knowledge/11-婚姻家庭与生命周期.md"),
    (["分手", "背叛", "复合", "出轨", "关系修复", "前任", "信任", "劈腿", "原谅", "和好", "拉黑", "感情破裂"], "knowledge/15-分手背叛与关系修复.md"),
    (["家暴", "跟踪", "胁迫", "法律", "危机", "安全", "自伤", "自杀", "虐待", "威胁", "骚扰", "人身安全"], "knowledge/17-中国法律安全与危机转介.md"),
    (["证据", "来源", "书单", "论文", "延伸阅读", "证据分级", "靠谱", "科学", "技巧"], "knowledge/01-证据分级与内容边界.md"),
    (["实用", "指南", "导读"], "practical/00-导读与使用分级.md"),
    # v1.9.0：伦理转译（表达风格/情话润色），源自上游新增文档
    (["表达", "情话", "润色", "开场白", "怎么表达", "诗意", "夸人", "夸女", "安慰", "调情"], "practical/公开表达案例的伦理转译.md"),
]
